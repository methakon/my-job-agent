...
- [ ] **Decision: approve queue items** (user) — top: Virvon Node/NestJS 100/90, Zoftsolutions 100/67, Vistateq AWS Backend 100/85, Resolvent 80/85, Astroidea 80/85, Fingerprintjs 40/85, Guidepoint 40/100, Squadio 50/100 (astro-scored by job-relevant window).
