...
## Pending — engineering
- [ ] **Indus folder — documents checked & sectionised; profile update with verified facts** (user rule 2026-08-27: "check the documents and sectionised them depending on the content type", "use this folder to do the profile section"; user asked to wait for model switch to a free one before processing). Folder `~/Downloads/indus` ALREADY sectionised into education/ (BCA_C, MCA_C, 12-C, 10-C), identity/ (PAN, aadhar, passport, UAN), offerletters/, release_experiance/, payslip/, ageproof/. All docs OCR'd to /tmp/indus_ocr/*.txt (rapidocr venv at /tmp/ocr; reinstall if wiped: `python3 -m venv /tmp/ocr && /tmp/ocr/bin/pip install rapidocr_onnxruntime`; tesseract NOT available, no sudo). Verified so far: BCA Dumkal Inst 2005 (DGPA 7.6), MCA June 2008 First class; HS WBCHSE Berhampore College 2002 (55%, 2nd div); Indus Net Senior SWE 27-04-2026→17-08-2026; CodeClouds Senior Engineer:Web 03-03-2025→28-02-2026; Han River SW Dev 26-02-2021→21-02-2025 (exit TL Backend); Experis relieved 21-07-2020 (offer 18-12-2015; profile says to:2020-06 → fix); Espirit relieved 30-11-2020; Sasken Engineer 01-02-2010→20-12-2011; Limtex Executive-WebDev 19-08-2014→02-09-2015; MGTathya System Analyst 19-08-2013→18-08-2014; Supercon relieved 18-08-2013; WebTek Senior Developer 03-09-2015→11-12-2015 (terminated); Veritos relieved 12-02-2021; PAN ALMPD4210G DOB 09/12/1982 (FLAG: memory/astrology says 09-12-1981 — ask user, never silently change). REMAINING: add 10th (WBBSE Madhyamik 1999, Khagra Gurudas Tarasundari Institution) + 12th (WBCHSE 2002) to educationJson; verify/add missing stints (MGTathya 2013-14, Supercon ≤2013, WebTek 2015) to workHistoryJson; fix Experis to 2020-07; rebuild CVs; commit+push.
