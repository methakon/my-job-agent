 ...
 *    route is behind the operator wall unless the request is local
 *    (localhost Host header), carries a session/password, or the route is
 *    marked @BypassAuth / @AllowIps (3rd-party callbacks, webhooks,
